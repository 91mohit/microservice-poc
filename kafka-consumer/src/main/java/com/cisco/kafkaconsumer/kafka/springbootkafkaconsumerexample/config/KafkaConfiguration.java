...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, CurrencyBean> userConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CurrencyBean> conversionKafkaListenerFactory() {
